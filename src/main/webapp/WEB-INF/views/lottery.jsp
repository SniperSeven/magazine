...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="/cssssss/HTML5/js/jquery-1.10.2.js"></script>
    <script type="text/javascript" src="/cssssss/HTML5/js/awardRotate.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            //动态添加大转盘的奖品与奖品区域背景颜色
            turnplate.restaraunts = ["咖喱蛋糕", "人品极佳", "辣味蛋糕", "java半年券", "蛋黄酱拌果冻", " 遛得上天", "草莓蛋糕", "猴赛雷  "];
            turnplate.colors = ["#FFFFFF","#f6da9e", "#FFFFFF", "#f6da9e", "#FFFFFF","#f6da9e", "#FFFFFF", "#f6da9e" ];
            ...
            var rotateFn = function (item, txt){
                ...
                $('#wheelcanvas').rotate({
                    ...
                    callback:function (){	//回调
                        alert("恭喜 -${username}- 获得:"+txt);
                        var lot = $("#lotteryController");
                        lot.attr("action","/lottery.do?present="+txt);
                        lot.submit();
                    }
                });
            };
...
<body style="background:url(/cssssss/HTML5/images/body_bg.jpg);background-size:cover;">
<img src="/cssssss/HTML5/images/4.png" id="shan-img" style="display:none;" />
<img src="/cssssss/HTML5/images/3.png" id="diy2-img" style="display:none;" />
<img src="/cssssss/HTML5/images/5.png" id="diy1-img" style="display:none;" />
<img src="/cssssss/HTML5/images/6.png" id="diy3-img" style="display:none;" />
<img src="/cssssss/HTML5/images/7.png" id="diy4-img" style="display:none;" />
<img src="/cssssss/HTML5/images/7.png" id="diy5-img" style="display:none;" />
<div class="banner" style="margin-top: 35%">
    <div class="turnplate" style="background-image:
    url(/cssssss/HTML5/images/cj_bg.png);background-size:100% 100%;">
        <canvas class="item" id="wheelcanvas" width="422px" height="422px"></canvas>
        <img class="pointer" src="/cssssss/HTML5/images/jt2.png"/>
    </div>
</div>
<form action="/lottery.do" id="lotteryController" method="post"></form>

<%--<a href="#" class="more"></a>--%>
<%--<img src="/cssssss/HTML5/images/9.png" class="cloud">--%>
<%--<img src="/cssssss/HTML5/images/10.png" class="cloud2">--%>
<%--<img src="/cssssss/HTML5/images/11.png" class="cloud3">--%>
